...
<form action="/notes" method="POST">
    ...
    <div class="flex justify-between items-center">
        <input name="title" id="title" class="text-indigo-900 font-bold focus:outline-none  border-none text-4xl my-10 focus:shadow-inherit" value="<?= $note['title'] ?>" />
    ...
    <div id="tabs-1-panel-1" class="-m-0.5 rounded-lg p-0.5" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
        ...
        <textarea rows="5" name="note" id="note" class="block w-full h-screen rounded-md border-none py-1.5 text-gray-900 shadow-sm placeholder:text-gray-400 sm:text-lg sm:leading-6" placeholder="Add your notes..."><?= $note['note'] ?></textarea>
        </div>
    </div>
