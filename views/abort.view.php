...
<main class="relative isolate min-h-full">
  <img src="https://images.pexels.com/photos/7766717/pexels-photo-7766717.jpeg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-top">
  <div class="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
    ...
    <div class="mt-10 flex justify-center">
      <a href="/login" class="text-sm font-semibold leading-7 text-white"><span aria-hidden="true">&larr;</span> Back to home</a>
    </div>
  </div>
</main>
