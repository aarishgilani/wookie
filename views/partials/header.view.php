<!-- Header:Partial -->
<div class="bg-white">
  <div class="max-w-screen-xl mx-auto py-16 px-4 sm:pt-24 sm:px-6 lg:px-8">
    <div class="text-center">
      <!-- <h1 class="text-base leading-6 font-semibold text-indigo-600 tracking-wide uppercase">Pricing</h1> -->
      <p class="mt-1 text-4xl leading-10 font-extrabold text-indigo-900 sm:text-5xl sm:leading-none sm:tracking-tight lg:text-6xl"><?= $heading ?? pageTitle() ?></p>
